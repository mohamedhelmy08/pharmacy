  ...
  <div class="site-wrap">
            ...
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="phlogin">Login</a></li>
                    <li><a href="phregister">Sign Up </a></li>
                  </ul>
                </li>
              </ul>
            </nav>
    ...
    <div class="site-section">
      <div class="container" style="padding-left: 180px;">
        <div class="row">
          <div class="col-md-10">
            <h2 class="h3 mb-5 text-black">Sign Up Form</h2>
          </div>
          <div class="col-md-10">
    
            <form method="POST" action="{{ route('phregister') }}">
                        @csrf
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('Oname') is-invalid @enderror" value="{{ old('Oname') }}" id="Oname" name="Oname">
                  </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                  <div class="col-md-12">
                      <label for="password-confirm" class="text-black">{{ __('Confirm Password') }}</label>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            <p>
              ...
              Copyright &copy;
              <script>document.write(new Date().getFullYear());</script> All rights reserved | By Pharma
               <i class="icon-heart" aria-hidden="true"></i> by <a href="#" target="_blank"
                class="text-primary">Pharma Team</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
