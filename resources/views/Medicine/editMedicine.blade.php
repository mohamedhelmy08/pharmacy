      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Edit Medicine</strong>
          </div>
        </div>
      </div>
    </div>
...
<div class="container">
    <div class="row">
     <div class="col-md-12 mb-0">
           <div class="row mb-5">
              <div class="col-md-12">
                <h2 class="h3 mb-3 text-black">Edit Medicine</h2>              
                <div class="p-3 p-lg-5 border">
            <form method="POST" action="{{ url('/Medicine/editMedicine/'. $medicine->id) }}">
                        @csrf
                    <div class="form-group row">
                      ...
                      <select name="branch"  class="form-control"  required="">
                        @foreach ($branchs as $value)
                         @if($medicine->Branch_ID == $value->Branch_ID )
                            <option selected="selected" value="{{$value->Branch_ID}}">{{ $value->Region_Name }} Branch</option>
                         @else
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{$medicine->Product_Name}}" id="mname" name="mname">
                      </div>
                      <div class="col-md-6">
                        <label for="category" class="text-black">Category<span class="text-danger">*</span></label>
                    <select name="category"  class="form-control"  required="">
                      @foreach ($categories as $value)
                        @if($medicine->Cat_ID == $value->Cat_ID )
                          <option selected="selected" value="{{$value->Cat_ID}}">{{ $value->Category_Name }}</option>
                        @else
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        ...
                        <input id="uprice" type="Number" class="form-control" name="uprice" required value="{{$medicine->Price}}">
                      </div>
                      <div class="col-md-6">
                        <label for="qty" class="text-black">Quantity <span class="text-danger">*</span></label>
                        <input id="qty" value="{{$medicine->QTY}}" type="Number" class="form-control" name="qty" required >
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-12">
